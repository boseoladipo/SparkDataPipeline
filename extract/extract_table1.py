...
spark = SparkSession.builder.appName('extract__CUST_ACCOUNT').config('spark.scheduler.mode','FAIR').enableHiveSupport().getOrCreate()
...
table_name = '/_CUST_ACCOUNT'
upload_table_name = '/_UPLOAD_CUST_ACCOUNT'

data1_combined_key = 'CUST_AC_NO'
